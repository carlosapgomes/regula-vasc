...
@admin.register(Case)
class CaseAdmin(admin.ModelAdmin[Case]):
...
class CaseEventAdmin(admin.ModelAdmin[CaseEvent]):
...
class CaseAttachmentAdmin(admin.ModelAdmin[CaseAttachment]):
...
class CaseCommunicationMessageAdmin(admin.ModelAdmin[CaseCommunicationMessage]):
